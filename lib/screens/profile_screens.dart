...
import 'package:test_project/utils/app_lauout.dart';
import 'package:test_project/utils/app_styles.dart';
import 'package:test_project/widgets/column_layout_widget.dart';
import 'package:test_project/widgets/layout_builder_widget.dart';
              ...
              Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: const DecorationImage(
                        image: AssetImage("assets/images/img_1png.jpg"))),
              ),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: Styles.headLineStyle2.copyWith(
                            fontWeight: FontWeight.bold,color: Colors.white.withOpacity(.9), fontSize: 16
                          ),
                        )
                      ],
                    )
          ...
          Container(
            ...
            child: Column(
              children: [
                const Gap(15),
                Text(
                  "192802",style: TextStyle(fontSize: 45, color: Styles.textColor, fontWeight: FontWeight.w600),
                  ),
                const Gap(20),
                Row(
